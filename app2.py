...
# Contraseña de aplicación (Limpia y sin espacios ocultos)
app.config['MAIL_PASSWORD'] = 'yttpwcijszdjkdny'
app.config['MAIL_DEFAULT_SENDER'] = ('Velrosse Store', 'velrossestore@gmail.com')

mail = Mail(app)

# Función para enviar el correo sin bloquear la carga de la página
...
<head>
    ...
    <style>
        ...
        .btn-submit { background: var(--pink); color: #fff; border: none; width: 100%; padding: 25px; border-radius: 10px; font-size: 24px; font-weight: 900; cursor: pointer; text-transform: uppercase; margin-top: 15px; animation: shake 0.5s infinite; }
        @keyframes shake { 0% { transform: translate(1px, 1px) rotate(0deg); } 10% { transform: translate(-1px, -2px) rotate(-1deg); } 30% { transform: translate(3px, 2px) rotate(0deg); } 50% { transform: translate(-1px, 2px) rotate(1deg); } 70% { transform: translate(3px, 1px) rotate(-1deg); } 90% { transform: translate(1px, 2px) rotate(0deg); } 100% { transform: translate(1px, -2px) rotate(-1deg); } }
        ...
        #successModal { display: {% if success %} flex {% else %} none {% endif %}; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.85); z-index: 10000; justify-content: center; align-items: center; }
        ...
        @media (max-width: 768px) { .main-grid { grid-template-columns: 1fr; } .features-grid { grid-template-columns: repeat(2, 1fr); } .footer-grid { grid-template-columns: repeat(2, 1fr); } }
    </style>
</head>
<body>
    <div id="successModal">
        <div class="modal-content">
            ...
            <br><br><a href="/" style="color: #888; text-decoration: none; font-size: 12px;">VOLVER</a>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="main-grid">
            <div class="gallery-box">
                ...
                <div class="main-img-box"><img src="/imagenes_fajas/faja (1).jpg" id="mainPhoto"></div>
            </div>
            ...
            <div class="purchase-box">
                ...
                <div class="price-row">
                    <div><span style="text-decoration:line-through; color:#999;">ANTES: $159.900</span><br><span class="price-now">$89.900</span></div>
            ...
            for (let i = 1; i <= qty; i++) {
                container.innerHTML += `
                    <div class="item-selection-box">
                        <strong style="color:var(--pink);">Faja #${i}</strong>
